...
with sync_playwright() as p:
    ...
    for name in ['11', '12']:
        target = page.locator('.navigation-row', has=page.locator(f'button.navigation-page span:text-is("{name}")')).first
        ...
        print(f'--- {name}: 保存草稿点击={clicked}, PUT application 累计={len(put_app)}')
        # 退出编辑
