...
with sync_playwright() as p:
    ...
    page.goto(f'{BASE}/app-center/application/{app_code}/runtime', wait_until='networkidle')
    page.wait_for_timeout(4000)
    page.locator('.navigation-row button.navigation-page:has(span:text-is("12"))').first.click()
    page.wait_for_timeout(3500)
    info = page.evaluate(EXTRACT)
    print('RENDERED PAGE 12 BLOCKS:', json.dumps(info, ensure_ascii=False, indent=1))
