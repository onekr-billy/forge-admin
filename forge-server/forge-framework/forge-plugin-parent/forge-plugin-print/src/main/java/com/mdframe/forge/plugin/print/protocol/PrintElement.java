 ...
 */
public record PrintElement(String id, String type, Double xMm, Double yMm, Double widthMm, Double heightMm, Binding binding, Format format, Style style, String barcodeFormat, String pageNumberFormat, Double rotationDeg, Boolean flipX, Boolean flipY, Boolean locked) {
