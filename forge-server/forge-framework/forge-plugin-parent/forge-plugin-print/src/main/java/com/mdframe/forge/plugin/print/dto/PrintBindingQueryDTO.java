...
public record PrintBindingQueryDTO(@NotNull @Positive Long applicationId, @NotNull PrintSourceType sourceType, @Pattern(regexp = "[A-Za-z0-9][A-Za-z0-9_.:-]{0,127}") String pageId, @Size(max = 128) String formKey, @NotBlank String objectCode, @NotNull PrintScene scene) {
