...
public class SysMonitorController {
    ...
    public void assertPlatformAdmin() {
        SessionHelper.assertAdmin("只有超级管理员可以查看系统监控");
    }
     ...
     */
    @GetMapping("/info")
    public RespInfo<Map<String, Object>> getSystemInfo() {
     ...
     */
    @GetMapping("/cpu")
    public RespInfo<Map<String, Object>> getCpu() {
        return RespInfo.success(getCpuInfo());
    }
     ...
     */
    @GetMapping("/memory")
    public RespInfo<Map<String, Object>> getMemory() {
        return RespInfo.success(getMemoryInfo());
    }
     ...
     */
    @GetMapping("/jvm")
    public RespInfo<Map<String, Object>> getJvm() {
        return RespInfo.success(getJvmInfo());
    }
     ...
     */
    @GetMapping("/disk")
    public RespInfo<List<Map<String, Object>>> getDisk() {
        return RespInfo.success(getDiskInfo());
    }
     ...
     */
    @GetMapping("/server")
    public RespInfo<Map<String, Object>> getServer() {
        return RespInfo.success(getServerInfo());
    }
