...
public class SysNoticeController {
    ...
    public RespInfo<Page<SysNotice>> page(PageQuery pageQuery, SysNoticeQuery query) {
    ...
    public RespInfo<List<SysNotice>> list(SysNoticeQuery query) {
    ...
    public RespInfo<SysNoticeVO> getById(@RequestParam Long noticeId) {
    ...
    public RespInfo<Void> add(@RequestBody SysNoticeDTO dto) {
    ...
    public RespInfo<Void> edit(@RequestBody SysNoticeDTO dto) {
    ...
    public RespInfo<Void> remove(@RequestParam Long noticeId) {
    ...
    public RespInfo<Void> removeBatch(@RequestBody Long[] noticeIds) {
    ...
    public RespInfo<Void> publish(@RequestParam Long noticeId) {
        boolean result = noticeService.publishNotice(noticeId);
        return result ? RespInfo.success() : RespInfo.error("发布失败");
    }
    ...
    public RespInfo<Void> revoke(@RequestParam Long noticeId) {
        boolean result = noticeService.revokeNotice(noticeId);
        return result ? RespInfo.success() : RespInfo.error("撤回失败");
    }
    ...
    public RespInfo<Void> top(@RequestParam Long noticeId,
    ...
    public RespInfo<NoticeReadStatisticsVO> getStatistics(@PathVariable Long noticeId) {
    ...
    public RespInfo<List<NoticeReadUserVO>> getReadUsers(@PathVariable Long noticeId) {
    ...
    public RespInfo<List<NoticeReadUserVO>> getUnreadUsers(@PathVariable Long noticeId) {
