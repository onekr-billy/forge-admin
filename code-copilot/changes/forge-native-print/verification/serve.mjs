...
const config = {
  ...
  plugins: [vue(), ...(persistence ? [printMockPlugin(root)] : [])],
  ...
  build: { outDir: '/private/tmp/forge-print-verification-dist', ...(persistence ? { rollupOptions: { input: path.join(root, 'persistence.html') } } : {}), emptyOutDir: true },
}
